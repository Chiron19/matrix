const fonts = {
	coptic: {
		...
		glyphMSDFURL: "libs/matrix/assets/coptic_msdf.png",
		glyphSequenceLength: 32,
		glyphTextureGridSize: [8, 8],
	},
	gothic: {
		// The script the Codex Argenteus was written in
		glyphMSDFURL: "libs/matrix/assets/gothic_msdf.png",
		glyphSequenceLength: 27,
		glyphTextureGridSize: [8, 8],
	},
	matrixcode: {
		// The glyphs seen in the film trilogy
		glyphMSDFURL: "libs/matrix/assets/matrixcode_msdf.png",
		glyphSequenceLength: 57,
		glyphTextureGridSize: [8, 8],
	},
	megacity: {
		// The glyphs seen in the film trilogy
		glyphMSDFURL: "libs/matrix/assets/megacity_msdf.png",
		glyphSequenceLength: 64,
		glyphTextureGridSize: [8, 8],
	},
	resurrections: {
		// The glyphs seen in the film trilogy
		glyphMSDFURL: "libs/matrix/assets/resurrections_msdf.png",
		glintMSDFURL: "libs/matrix/assets/resurrections_glint_msdf.png",
		glyphSequenceLength: 135,
		glyphTextureGridSize: [13, 12],
	},
	huberfishA: {
		glyphMSDFURL: "libs/matrix/assets/huberfish_a_msdf.png",
		glyphSequenceLength: 34,
		glyphTextureGridSize: [6, 6],
	},
	huberfishD: {
		glyphMSDFURL: "libs/matrix/assets/huberfish_d_msdf.png",
		glyphSequenceLength: 34,
		glyphTextureGridSize: [6, 6],
	},
	gtarg_tenretniolleh: {
		glyphMSDFURL: "libs/matrix/assets/gtarg_tenretniolleh_msdf.png",
		glyphSequenceLength: 36,
		glyphTextureGridSize: [6, 6],
	},
	gtarg_alientext: {
		glyphMSDFURL: "libs/matrix/assets/gtarg_alientext_msdf.png",
		glyphSequenceLength: 38,
		glyphTextureGridSize: [8, 5],
	},
	neomatrixology: {
		glyphMSDFURL: "libs/matrix/assets/neomatrixology_msdf.png",
...
const textureURLs = {
	sand: "libs/matrix/assets/sand.png",
	pixels: "libs/matrix/assets/pixel_grid.png",
	mesh: "libs/matrix/assets/mesh.png",
	metal: "libs/matrix/assets/metal.png",
};
